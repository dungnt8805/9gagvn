...
namespace {
    ...
    class ImageManager extends \App\Funny\Facades\ImageFacade{
         ...
         * @static 
         */
        public static function saveFile($file, $content, $dir = ''){
            return \App\Funny\Services\Image::saveFile($file, $content, $dir);
        }
        ...
        public static function deleteFile($path){
            return \App\Funny\Services\Image::deleteFile($path);
        }
        
    }


    class Timthumb extends \App\Funny\Facades\TimthumbFacade{
         ...
         * @static 
         */
        public static function link($url, $width = 100, $height = 100, $zc = 1){
            return \App\Funny\Services\Timthumb::link($url, $width, $height, $zc);
        }
