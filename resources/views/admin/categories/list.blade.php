                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group pull-right">
                                        <a class="btn btn-primary btn-xs" href="{{url('admin/categories/view/'.$value['id'])}}">{{ trans('admin.actions.edit') }}</a>
                                        <a class="delete_toggler btn btn-danger btn-xs" rel="{{$value['id']}}">{{ trans('admin.actions.delete') }}</a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
