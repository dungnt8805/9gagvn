...
@section("content")
    <link href="{!! asset('resources/gag/components/jquery-minicolors/jquery.minicolors.css') !!}" rel="stylesheet"
          type="text/css">
    {!! Form::open(['url'=>'/admin/settings','id'=>'media-form','enctype'=>'multipart/form-data']) !!}
    <ul>
        <li>
            <label for="website_title">{!! trans('lang.website_title') !!}</label>
            {!! Form::text('website_title',$settings['website_title'],['class'=>'form-control']) !!}
        </li>
        <li>
            <label for="website_description">{!! trans('lang.website_description') !!}</label>
            {!! Form::text('website_description',$settings['website_description'],['class'=>'form-control']) !!}
        </li>
        <li>
        ...
        <li>
            ...
            <div id="captcha_block"
                 @if(isset($settings['user_registration']) && $settings['user_registration'] == 1) style="display:block" @endif>
                ...
                <div id="captcha_info"
                     @if(isset($settings['captcha']) && $settings['captcha'] == 1) style="display:block" @endif>
        ...
        <li>
            ...
            <div id="infinite_scroll_load_more_block"
                 @if(isset($settings['infinite_scroll']) && $settings['infinite_scroll'] == 1) style="display:block"
        ...
        <li>
            ...
            <div class="enable_watermark_info"
                 @if(isset($settings['enable_watermark']) && $settings['enable_watermark'] == 1) style="display:block" @endif>
                <div class="image">
                    <label for="watermark_image">{!! Lang::get('lang.watermark') !!}:</label>
                    <img src="{!! Config::get('site.uploads_dir') . '/settings/' . $settings['watermark_image'] !!}"
                         width="auto"/>
        ...
        <li>
            ...
            <div id="pages_in_menu_text_block"
                 @if(isset($settings['pages_in_menu']) && $settings['pages_in_menu'] == 1) style="display:block"
                 @else style="display:none" @endif>
    ...
    <script type="text/javascript"
            src="{!! asset('resources/components/jquery-minicolors/jquery.minicolors.min.js') !!}"></script>
    <script type="text/javascript">
