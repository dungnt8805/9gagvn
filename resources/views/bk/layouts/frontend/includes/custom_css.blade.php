...
@if(isset($app_settings['primary_color']))

	<?php $primary_color = $app_settings['primary_color']; ?>
...
@if(isset($app_settings['secondary_color']))

	<?php $secondary_color = $app_settings['secondary_color']; ?>
...
.btn.btn-color, input[type="submit"]{
    ...
    @if(isset($app_settings['random_bar_enabled']) && $app_settings['random_bar_enabled'] == 0)
