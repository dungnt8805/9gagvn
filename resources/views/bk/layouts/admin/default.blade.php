...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{asset('resources/funny/admin/css/AdminLTE.min.css')}}">
...
<div class="wrapper">
    ...
    <footer class="main-footer">
        @include('bk.layouts.admin._partials.footer')
    </footer>
...
<!-- FastClick -->
<script src="{{asset('resources/components/fastclick/fastclick.min.js')}}"></script>
<!-- AdminLTE App -->
<script src="{{asset('resources/funny/admin/js/app.min.js')}}"></script>
<!-- Sparkline -->
<script src="{{asset('resources/components/sparkline/jquery.sparkline.min.js')}}"></script>
<!-- jvectormap -->
<script src="{{asset('resources/components/jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
<script src="{{asset('resources/components/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
<!-- SlimScroll 1.3.0 -->
<script src="{{asset('resources/components/slimScroll/jquery.slimscroll.min.js')}}"></script>
<!-- ChartJS 1.0.1 -->
<script src="{{asset('resources/components/chartjs/Chart.min.js')}}"></script>
